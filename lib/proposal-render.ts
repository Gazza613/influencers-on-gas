...
function closedLoopPage(d: ProposalDoc, ci: CiTokens): string {
  ...
  return section(pageDark(ci, "52px 60px 40px"),
    ...
    +   `<div style="position:absolute;left:310px;top:310px;transform:translate(-50%,-50%);width:236px;height:236px;border-radius:50%;background:radial-gradient(circle,${ci.glow} 0%,transparent 70%);"></div>`
    ...
    +   `<div style="position:absolute;left:310px;top:372px;transform:translateX(-50%);width:220px;text-align:center;"><div style="font-size:12px;font-weight:700;letter-spacing:0.2em;text-transform:uppercase;">The Agency of NOW</div><div style="font-size:10px;font-weight:600;letter-spacing:0.14em;text-transform:uppercase;margin-top:4px;color:${ci.accentOnDark};">From Interest to Intent</div></div>`
    + `</div></div>`
