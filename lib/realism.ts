...
export function buildShotPrompt(o: {
  ...
  return [
    ...
    o.role === "a-roll"
      ...
      : `Framing: ${o.shot}. B-ROLL FRAMING — she is a clear, PROMINENT subject: a medium shot where her face is plainly visible and identifiable (never a tiny, distant or fully-away figure), so her locked identity holds even in the wider scene. ONE single framing of ONE camera angle only — never a close-up combined with a wider shot, and never two views stacked together.`,
