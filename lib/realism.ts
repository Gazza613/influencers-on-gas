...
export const SCENE_PEOPLE =
  ...
  "ABSOLUTE RULE ON COUPLES — background people are INDIVIDUALS going about their own SEPARATE activities; do NOT arrange them into romantic couples or paired-up duos. IF any two people unavoidably read as a couple/pair (walking, sitting or standing together), they MUST be the SAME race as each other (white+white, black+black, coloured+coloured, indian+indian). A mixed-race / interracial couple in the background is STRICTLY FORBIDDEN — never pair two people of different races together. When in doubt, keep people solo or make the pair the same race; " +
