...
export function buildShotPrompt(o: {
  ...
  return [
    ...
    o.role === "a-roll"
      ? "COMPOSITION: place her eyes on the upper-third line with natural headroom (not too much dead space above); camera at eye level or just 10-15 degrees above for a flattering angle, never looking down on her; the background simple and softly separated behind her."
