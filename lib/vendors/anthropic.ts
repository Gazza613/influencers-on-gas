  ...
  try {
    ...
    const res = await c.messages.create({
      ...
      system:
        ...
        (opts.extras ? "Include a believable, busy background crowd composed of roughly 70% white people and 30% black people, with an even 50/50 split of men and women of varied ages, and a mix of individuals, couples and small groups, in sharp focus. " : "No other people in the scene. ") +
