...
ROLES — classify every scene as ONLY 'a-roll' or 'b-roll' (never 'graphic'): 'a-roll' = the influencer IN the scene talking to camera (sitting, standing or walking in the location, setting + extras visible behind, never a plain backdrop); 'b-roll' = a lifestyle/scene shot in the SAME location with NATURAL MOTION and believable background people, NO talking (music carries it). In a-roll and b-roll motion_prompts include believable body movement (sitting down, gesturing, walking) and that background people move.
