...
export function emailHeader(strapline: string, dateLabel: string): string {
  return `
  <div style="text-align:center;padding:10px 0 22px;">
    ...
    <div style="margin-top:6px;font-size:30px;font-weight:800;letter-spacing:1px;color:#ffffff;">INFLUENCERS <span style="color:#f96203;">ON GAS</span></div>
...
export function emailSignature(cadence: string): string {
  return `
...
export function emailShell(opts: { strapline: string; dateLabel: string; body: string; cadence: string }): string {
  return `
  <div style="background:#07090d;padding:24px 0;font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;">
    <div style="max-width:640px;margin:0 auto;padding:0 18px;">
      ${emailHeader(opts.strapline, opts.dateLabel)}
      ${opts.body}
      ${emailSignature(opts.cadence)}
    </div>
  </div>`;
}
