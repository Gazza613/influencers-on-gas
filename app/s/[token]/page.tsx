    ...
    >
      ...
      <div className="relative overflow-hidden border-b border-white/5">
        <div className="relative mx-auto max-w-3xl px-6 pb-14 pt-16 text-center sm:pt-24">
          ...
          <span className="inline-block rounded-full border border-white/15 bg-white/5 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-white/70">The Agency of NOW</span>
      ...
      <footer className="border-t border-white/10">
        <div className="mx-auto max-w-6xl px-6 py-10">
          ...
          <p className="mt-7 border-t border-white/5 pt-5 text-center text-xs text-white/35">
            Response marketing, powered by AI · Produced with The Agency of NOW · © GAS Marketing
          </p>
        </div>
      </footer>
    </div>
