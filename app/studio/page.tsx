      ...
      <main className="min-h-0 flex-1 overflow-y-auto">
        <div className="mx-auto max-w-6xl space-y-14 px-6 py-12">
          ...
          <section className="rise">
            ...
            <p className="mt-4 max-w-xl text-[15px] leading-relaxed text-ink-dim">Direct a hyper-real AI influencer: write it in Script &amp; Voice, then build it in The Final Cut - keyframes, lip-synced talking shots, cinematic scene shots, music and the final cut.</p>
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <Link href="/start" className="btn-brand rounded-xl px-6 py-3.5 text-sm font-bold">🎬 Start a production</Link>
            </div>
            {/* Stat strip */}
            ...
            {influencers.length === 0 ? (
              <div className="rounded-2xl border border-dashed border-line bg-surface-1 p-8 text-center">
                ...
                <div className="mx-auto mt-5 grid max-w-2xl gap-3 text-left sm:grid-cols-3">
                  {[["1", "Cast & shoot", "Build the influencer and shoot a varied identity set."], ["2", "Lock the identity", "Lock the face so every shot stays consistent."], ["3", "Produce the video", "Write it in Script & Voice, then build it in The Final Cut."]].map(([n, t, d]) => (
