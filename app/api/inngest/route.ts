...
import { generateCandidates, buildIdentity, createPresenter, enhanceRealism, trainSoulJob, ingestSource } from "@/inngest/functions";
...
export const { GET, POST, PUT } = serve({
  client: inngest,
  functions: [generateCandidates, buildIdentity, createPresenter, enhanceRealism, trainSoulJob, ingestSource],
