...
import { buildResearchDocumentJob, onResearchApproved } from "@/inngest/research";
...
export const { GET, POST, PUT } = serve({
  client: inngest,
  functions: [generateCandidates, buildIdentity, createPresenter, trainSoulJob, ingestSource, generateCreatives, upscaleCreative, generateAroll, generateShots, generateClips, generateAudio, assembleVideo, reshootShot, videoSpike, buildResearchDocumentJob, onResearchApproved],
