...
export const metadata: Metadata = {
  title: "THE AGENCY OF NOW",
  description: "The Agency of NOW - GAS Marketing's platform for market intelligence, creative and live campaigns.",
};
