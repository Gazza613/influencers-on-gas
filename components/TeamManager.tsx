    ...
    <div className="mx-auto max-w-5xl">
      ...
      <div className="glow-accent mt-5 rounded-xl bg-surface-1 p-4">
        ...
        <div className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-[1fr_1fr_auto_auto]">
          ...
          <button onClick={invite} disabled={busy || !email.trim()} className="btn-brand inline-flex items-center justify-center gap-2 rounded-lg px-5 py-2.5 text-lg font-bold disabled:opacity-50">
